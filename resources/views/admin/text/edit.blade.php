...
@section('title', 'Admin | Alterar Texto') {{--Define o titulo da pagina (posicionado na masterpage)--}}
...
{{--    <h1 class="verticalMarginModal">Alterar Imagem com ID: {{$product->id}}</h1>--}}
    ...
    <a href="{{ route('ListSlideshow') }}" class="btn btn-lg btn-primary verticalMarginModal">Lista de Textos</a>
